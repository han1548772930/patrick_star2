//! macOS native implementations: AppKit and ScreenCaptureKit/CoreGraphics.
...
impl DesktopCapture for Backend {
    fn capture_virtual_desktop(&self) -> anyhow::Result<DesktopFrame> {
        anyhow::bail!("macOS ScreenCaptureKit backend is not implemented yet")
    }
}
...
impl ImageClipboard for Backend {
    fn write_image(&self, _image: &RgbaFrame) -> anyhow::Result<()> {
        anyhow::bail!("macOS image clipboard backend is not implemented yet")
    }
}

impl TextClipboard for Backend {
    fn write_text(&self, _text: &str) -> anyhow::Result<()> {
        anyhow::bail!("macOS text clipboard backend is not implemented yet")
    }
}

impl TextRecognizer for Backend {
    fn available_languages(&self) -> anyhow::Result<Vec<OcrLanguage>> {
        anyhow::bail!("macOS Vision OCR backend is not implemented yet")
    }
...
impl ImageSaveDialog for Backend {
    fn choose_image_target(
        ...
        anyhow::bail!("macOS image save dialog is not implemented yet")
    }
}
...
impl DirectoryPicker for Backend {
    fn choose_directory(
        ...
        anyhow::bail!("macOS directory picker is not implemented yet")
    }
}

impl PinnedImageHost for Backend {
    fn show_pinned_image(&self, _image: RgbaFrame) -> anyhow::Result<()> {
        anyhow::bail!("macOS pinned image host is not implemented yet")
    }
}
...
impl ScrollCaptureSource for Backend {
    fn start_scroll_capture(
        ...
        anyhow::bail!("macOS scroll capture source is not implemented yet")
    }
...
impl ScrollPreviewHost for Backend {
    fn open_scroll_preview(
        ...
        anyhow::bail!("macOS scroll preview host is not implemented yet")
    }
}
